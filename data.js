...
const ARTICLES = [
  ...
  {
    id: 'a-001',
    slug: 'abome-elephant-deces-guinee-en-deuil',
    title: 'Abomé l\'Éléphant nous a quittés : la Guinée perd une de ses voix les plus puissantes',
    excerpt: 'L\'artiste guinéen emblématique s\'est éteint cette semaine à Conakry. Retour sur le parcours d\'un homme qui a porté la culture guinéenne au-delà des frontières.',
    category: 'musique',
    ...
    featured: true,
    breaking: true,
    tags: ['guinée', 'abomé', 'hommage', 'conakry', 'culture guinéenne'],
    views: 142000,
  },
  {
    id: 'a-002',
    slug: 'didi-b-roi-rap-ivoirien-2026',
    title: 'Didi B : comment l\'Ivoirien est devenu le roi incontesté du rap francophone africain',
    excerpt: 'Avec son dernier projet, Didi B confirme une domination sans partage. Analyse d\'un artiste qui a tout compris à l\'ère du streaming africain.',
    category: 'musique',
    author: 'Kofi A.',
    authorImg: null,
    date: '2026-05-19',
    ...
    featured: true,
    breaking: false,
    tags: ['didi b', 'rap ivoirien', 'côte d\'ivoire', 'abidjan', 'hip-hop africain'],
    views: 89400,
  },
  {
    id: 'a-003',
    ...
    excerpt: 'Musique, mode, art, gastronomie — Conakry n\'a jamais été aussi créative. Dans les rues de Kaloum et Kipé, une génération entière refuse d\'attendre.',
    category: 'lifestyle',
    author: 'Marcus D.',
    authorImg: null,
    date: '2026-05-18',
  ...
  {
    id: 'a-004',
    slug: 'himra-algerie-conquete-afrique',
    title: 'Himra explose les compteurs : le phénomène algérien qui conquiert toute l\'Afrique',
    excerpt: 'Ses clips cumulent des centaines de millions de vues. Du Maghreb à l\'Afrique subsaharienne, Himra est partout. Comment un gamin d\'Alger est devenu la voix d\'une génération.',
    category: 'musique',
    author: 'Rédaction ONE',
    authorImg: null,
    date: '2026-05-20',
    ...
    featured: false,
    breaking: true,
    tags: ['himra', 'algérie', 'rap', 'maghreb', 'phénomène'],
    views: 118000,
  },
  ...
  {
    id: 'a-005',
    slug: 'trk-rap-guineen-nouvelle-vague',
    title: 'TRK et la nouvelle vague du rap guinéen : Conakry a son son',
    excerpt: 'Ils rappent en soussou, en pular, en français mélangé — et ils n\'ont aucune intention de s\'excuser pour ça. TRK incarne une génération de rappeurs guinéens qui redéfinissent les règles.',
    category: 'musique',
    author: 'Amadou S.',
    authorImg: null,
    date: '2026-05-17',
    ...
    featured: false,
    breaking: false,
    tags: ['trk', 'rap guinéen', 'guinée', 'conakry', 'hip-hop'],
    views: 44100,
  },
  {
    id: 'a-006',
    slug: 'rap-ivoirien-generation-2026',
    title: 'Rap ivoirien 2026 : la scène d\'Abidjan qui défie tout le monde',
    excerpt: 'Didi B, Bebi Philip, Suspect 95 — la Côte d\'Ivoire a construit en silence l\'une des scènes rap les plus solides du continent. Portrait collectif d\'une génération en fusion.',
    category: 'musique',
    author: 'Fatou N.',
    authorImg: null,
    date: '2026-05-16',
